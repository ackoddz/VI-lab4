...
class GraphProblem(Problem):
    ...
    def h(self, node):
        ...
        istr = GraphProblem(node.state, self.goal, self.graph);
        shortestPathLength = len(breadth_first_graph_search(istr).solve());
...
sequenceList = answer.solve();

pathCost = answer.path_cost;
